const fechar = document.querySelectorAll('.exit')
const modal = document.querySelectorAll('.modal')
const palavra = document.querySelectorAll('.palavraBotao')
...
function playAudio10(){
    let x = document.getElementById("audio10");
    x.load();
    x.play();
}
